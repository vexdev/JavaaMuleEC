...
public final static byte EC_OP_PARTFILE_UNUSED               = 0x15;
...
public final static short 	EC_TAG_STATS_ED2K_USERS                   = 0x0209;
...
public final static short 	EC_TAG_PARTFILE_STOPPED                   = 0x0317;
public final static short 	EC_TAG_PARTFILE_DOWNLOAD_ACTIVE           = 0x0318;
...
public final static short 	EC_TAG_KNOWNFILE_ON_QUEUE                 = 0x040C;
public final static short 	EC_TAG_KNOWNFILE_COMPLETE_SOURCES         = 0x040D;
public final static short 	EC_TAG_KNOWNFILE_COMMENT                  = 0x040E;
public final static short 	EC_TAG_KNOWNFILE_RATING                   = 0x040F;
...
public final static short 	EC_TAG_SERVER_IP                          = 0x050C;
public final static short 	EC_TAG_SERVER_PORT                        = 0x050D;
...
public final static short 	EC_TAG_CLIENT_FRIEND_SLOT                 = 0x0604;
...
public final static short 	EC_TAG_CLIENT_DOWNLOAD_STATE              = 0x060C;
...
public final static short 	EC_TAG_CLIENT_IDENT_STATE                 = 0x0617;
public final static short 	EC_TAG_CLIENT_OBFUSCATION_STATUS          = 0x0618;
public final static short 	EC_TAG_CLIENT_CURRENTLYUNUSED1            = 0x0619;
public final static short 	EC_TAG_CLIENT_REMOTE_QUEUE_RANK           = 0x061A;
public final static short 	EC_TAG_CLIENT_DISABLE_VIEW_SHARED         = 0x061B;
public final static short 	EC_TAG_CLIENT_UPLOAD_STATE                = 0x061C;
public final static short 	EC_TAG_CLIENT_EXT_PROTOCOL                = 0x061D;
public final static short 	EC_TAG_CLIENT_USER_ID                     = 0x061E;
public final static short 	EC_TAG_CLIENT_UPLOAD_FILE                 = 0x061F;
public final static short 	EC_TAG_CLIENT_REQUEST_FILE                = 0x0620;
public final static short 	EC_TAG_CLIENT_A4AF_FILES                  = 0x0621;
public final static short 	EC_TAG_CLIENT_OLD_REMOTE_QUEUE_RANK       = 0x0622;
public final static short 	EC_TAG_CLIENT_KAD_PORT                    = 0x0623;
...
public final static short 	EC_TAG_CLIENT_MOD_VERSION                 = 0x0628;
public final static short 	EC_TAG_CLIENT_OS_INFO                     = 0x0629;
public final static short 	EC_TAG_CLIENT_AVAILABLE_PARTS             = 0x062A;
public final static short 	EC_TAG_CLIENT_UPLOAD_PART_STATUS          = 0x062B;
...
public final static short 	EC_TAG_FRIEND_IP                          = 0x0803;
public final static short 	EC_TAG_FRIEND_PORT                        = 0x0804;
public final static short 	EC_TAG_FRIEND_CLIENT                      = 0x0805;
public final static short 	EC_TAG_FRIEND_ADD                         = 0x0806;
public final static short 	EC_TAG_FRIEND_REMOVE                      = 0x0807;
public final static short 	EC_TAG_FRIEND_FRIENDSLOT                  = 0x0808;
public final static short 	EC_TAG_FRIEND_SHARED                      = 0x0809;
...
public final static short 		EC_TAG_SECURITY_OBFUSCATION_SUPPORTED     = 0x1C09;
public final static short 		EC_TAG_SECURITY_OBFUSCATION_REQUESTED     = 0x1C0A;
public final static short 		EC_TAG_SECURITY_OBFUSCATION_REQUIRED      = 0x1C0B;
